 ...
 * @aside guide forms
 *
 * This is a specialized field which shows a {@link Xedu.ux.picker.DateTime} when tapped. If it has a predefined value,
 * or a value is selected in the {@link Xedu.ux.picker.DateTime}, it will be displayed like a normal {@link Ext.field.Text}
...
Ext.define('Xedu.ux.field.DateTimePicker', {
    ...
    config: {
        ...
        /**
         * @cfg {Object/Xedu.ux.picker.DateTime} picker
         * An object that is used when creating the internal {@link Xedu.ux.picker.DateTime} component or a direct instance of {@link Xedu.ux.picker.DateTime}
         * Defaults to true
         * @accessor
         */
        picker: true,
         ...
         * Default value for the field and the internal {@link Xedu.ux.picker.DateTime} component. Accepts an object of 'year',
     ...
     * @param {Xedu.ux.picker.DateTime} picker The date picker
